...
setup()
{
    GENESIS_SPEC="$(require_repo_file 'xCAT-genesis-base/xCAT-genesis-base.spec')"
    DRACUT_MODULE="$(require_repo_file 'xCAT-genesis-base/dracut_105/el/module-setup.sh')"
