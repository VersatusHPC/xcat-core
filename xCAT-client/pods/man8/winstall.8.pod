...
If you would like to run a task after deployment, you can define that task with this attribute. The legacy Genesis image runs this task. The OpenEmbedded Genesis image refuses it and reports B<UNSAFE_LEGACY_ACTION>; build a signed system extension with B<xCAT-genesis-builder/oe/export-extension>.
